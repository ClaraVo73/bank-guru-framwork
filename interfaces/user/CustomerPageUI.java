...
public class CustomerPageUI {
    ...
    public static final String CITY_ERROR_MESSAGE = "id=message4";
    public static final String STATE_TEXTBOX = "name=state";
    public static final String STATE_ERROR_MESSAGE = "id=message5";
    public static final String PIN_TEXTBOX = "name=pinno";
    public static final String PIN_ERROR_MESSAGE = "id=message6";
    public static final String MOBILE_NUMBER_TEXTBOX = "name=telephoneno";
